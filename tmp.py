...
h_idea_mapping = np.array([[0.75, 0.25], 
                      [0.25, 0.75]])
...
A = generate_likelihood(h_idea_mapping, h_control_mapping, num_neighbours = num_neighbours, num_outcast_levels = num_outcast_levels)