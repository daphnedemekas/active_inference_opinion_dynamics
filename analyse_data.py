...
for precision_l in lower_bounds:
    print(c_0, precision_l, precision_l+1, env_l_0, env_u_0, b_l_0, b_u_0)
    ratio = get_ratio_from_parameters(c_0, precision_l, u_0, env_l_0, env_u_0, b_l_0, b_u_0)
    print("ratio")
    print(ratio)
    y_axis.append(ratio)
