...
def update_posterior_states2(agent, obs, prior=None):
    """
    ...
    obs = utils.process_observation(obs, agent.genmodel.num_modalities, agent.genmodel.num_obs)
    if prior is not None:
        prior = utils.process_prior(prior, agent.genmodel.num_factors)
    #qs = fpi.run_fpi(agent.genmodel.A, obs, agent.genmodel.num_obs, agent.genmodel.num_states, prior, **agent.inference_params)

    qs = fpi.run_fpi2(agent, obs, prior)
