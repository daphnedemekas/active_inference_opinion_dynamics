...
def initialize_graph_and_agents(G, num_H, idea_levels, h_idea_mapping, belief2tweet_mapping):
    ...
    for i in G.nodes():
        ...
        env_det_param =  8#how determinstic the environmennt is in general
        belief_det_params = np.random.uniform(low=3.0, high=4.0, size=(num_neighbours,)) #how deterministic the nieghbours are specifically
...
T = 30          # number of timesteps in the simulation
N = 3   # total number of agents in network
